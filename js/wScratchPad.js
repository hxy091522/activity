(function ($) {
  ...
  ScratchPad.prototype = {
    _generate: function () {
      ...
      this.$img = $('<img src="images/after.png" >').attr('crossOrigin', '').css({position: 'absolute', width: '100%', height: '100%'});
  ...
  $.fn.wScratchPad.defaults = {
    ...
    bg          : '#ccc',  // Background (image path or hex color).
    fg          : 'images/before.png',  // Foreground (image path or hex color).
